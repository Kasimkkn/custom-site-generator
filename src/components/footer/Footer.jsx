...
const Footer = ({ data }) => {
    return (
        <footer className="text-background bg-primary px-4 py-5 md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                        <img src={data?.logo} className="w-32" alt='footer logo' />
                    ...
                    >
                        <span className="block pt-4 pb-2">
                            Stay up to date
                        </span>
                        <div className="max-w-sm flex items-center border rounded-md p-1">
                            ...
                            />
                            <button
                                className="p-2.5  text-background bg-text outline-none shadow-md focus:shadow-none sm:px-5"
                            >
                                Subscribe
                            </button>
                        </div>
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                ...
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        ...
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <button >
                                <svg className="svg-icon w-6 h-6 text-primary" viewBox="0 0 20 20">
