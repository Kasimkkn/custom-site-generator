            ...
            <div className="max-w-screen-2xl mx-auto px-4 md:px-8">
                ...
                <div className="mt-12">
                    <ul className="grid gap-8 lg:grid-cols-2">
                        {
                            data?.teamsCardsData.map((item, idx) => (
                                <li key={idx + 1} className="gap-8 sm:flex">
